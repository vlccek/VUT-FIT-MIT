...
df = pd.read_csv(
    ...
    dtype={
        ...
        "Peer pressure": int, 
        "Academic pressure from your home": int, 
        ...
        "What would you rate the academic  competition in your student life": int, 
...
clf = ImbPipeline([
    ...
    ('classification', RandomForestClassifier(random_state=42, n_estimators=100, class_weight='balanced')),
])

param_grid = {
    #'smote__k_neighbors': [3, 5],
    'adasyn__n_neighbors': [3, 5],
    'feature_selection__threshold': ['median', '0.7*mean', '0.85*mean'],
    'classification__max_depth': [7, 9, 5],
